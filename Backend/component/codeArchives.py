...
# V1 working code for recomedatiion 
...
#     # Extract all tool messages and their results
#     tool_results = {}
#     for msg in messages:
...
#     updated_messages = [SystemMessage(content=portfolio_prompt)]
#     for msg in messages:
...
#         print(f"\n[ERROR] Failed to parse LLM output. Raw content:\n{content}")
...
# portfolio_graph.add_conditional_edges("portfolio_agent", should_continue, {"tools": "tools", END: END})
...
#         print("\n[ERROR] No valid output generated. Last message:")
